...
$(function() {
  ...
  function toggleMenu(force) {
    ...
    $('.nav-trigger').toggleClass('is-active', menuOpen);
    $('.rail').toggleClass('is-open', menuOpen);
  ...
  $(document.body).on('click', '.nav-trigger', function() {
    toggleMenu();
    listenerId = document.body.addEventListener('click', closeMenu);
  });
});
